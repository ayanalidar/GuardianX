...
GRANT ALL ON "WebsiteScan" TO service_role; GRANT SELECT, INSERT, UPDATE, DELETE ON "WebsiteScan" TO anon, authenticated;
GRANT ALL ON "DetectionRule" TO service_role; GRANT SELECT, INSERT, UPDATE, DELETE ON "DetectionRule" TO anon, authenticated;
