...
CREATE TABLE IF NOT EXISTS "MemoryEntry" (id TEXT PRIMARY KEY, "userId" TEXT NOT NULL, category TEXT NOT NULL, title TEXT NOT NULL, content TEXT NOT NULL, tags TEXT, "createdAt" TIMESTAMPTZ NOT NULL DEFAULT NOW(), "updatedAt" TIMESTAMPTZ NOT NULL DEFAULT NOW());
...
GRANT ALL ON "MemoryEntry" TO service_role; GRANT SELECT, INSERT, UPDATE, DELETE ON "MemoryEntry" TO anon, authenticated;
